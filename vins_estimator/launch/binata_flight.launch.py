...
def generate_launch_description():
    ...
    config_path = PathJoinSubstitution([
        config_pkg_path,
        'config/binata_flight_data/binata_flight_config.yaml'
    ])
    ...
    return LaunchDescription([
        LogInfo(msg=['[binata_flight launch] config path: ', config_path]),
        LogInfo(msg=['[binata_flight launch] vins path: ', vins_path]),
        LogInfo(msg=['[binata_flight launch] support path: ', support_path]),
        vins_estimator_node,
        pose_graph_node
    ])