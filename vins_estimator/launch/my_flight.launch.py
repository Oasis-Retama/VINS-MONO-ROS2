...
def generate_launch_description():
    ...
    config_path = PathJoinSubstitution([
        config_pkg_path,
        'config/my_flight_data/my_flight_config.yaml'
    ])
    ...
    return LaunchDescription([
        LogInfo(msg=['[my_flight launch] config path: ', config_path]),
        LogInfo(msg=['[my_flight launch] vins path: ', vins_path]),
        LogInfo(msg=['[my_flight launch] support path: ', support_path]),
        vins_estimator_node,
        pose_graph_node
    ])